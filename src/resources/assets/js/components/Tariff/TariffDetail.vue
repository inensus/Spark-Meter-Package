                ...
                <md-card>
                    <md-card-content>
                        <div class="md-layout md-gutter">
                            ...
                            <!--Plan-->
                            <div v-if="tariffService.tariff.planEnabled"
                                 class="md-layout-item md-xlarge-size-33 md-large-size-33 md-medium-size-33 md-small-size-33">
                                <md-field :class="{'md-invalid': errors.has('Tariff-Form.plan_duration')}">
                                    <label for="plan_duration">Plan Duration</label>
                                    <md-select v-model="tariffService.tariff.planDuration"
                                               name="plan_duration"
                                               id="plan_duration">
                                        <md-option :value="'1m'">1m</md-option>
                                        <md-option :value="'1d'">1d</md-option>
                                    </md-select>
                                    <span class="md-error">{{ errors.first('Tariff-Form.plan_duration') }}</span>
                                </md-field>
                            </div>
                            <div v-if="tariffService.tariff.planEnabled"
                                 class="md-layout-item md-xlarge-size-33 md-large-size-33 md-medium-size-33 md-small-size-33">
                                ...
                                <div class="md-layout md-gutter">
                                    <div
                                        ...
                                        <md-field :class="{'md-invalid': errors.has('Tariff-Form.start'+tou.id)}">
                                            ...
                                            <md-select v-model="tou.start" name="start" id="start"
                                                       v-validate="{ required: tariffService.tariff.touEnabled }"
                                            ...
                                            <span class="md-error">{{ errors.first('Tariff-Form.start'+tou.id) }}</span>
                                        </md-field>
                                    </div>
                                    <div
                                            class="md-layout-item md-xlarge-size-20 md-large-size-20 md-medium-size-20 md-small-size-20">
                                        ...
                                        <md-field :class="{'md-invalid': errors.has('Tariff-Form.end'+tou.id)}">
                                            ...
                                            <md-select v-model="tou.end" name="end" id="end"
                                                       v-validate="{ required: tariffService.tariff.touEnabled }"
                                                       @md-selected="touSelected($event)">
                                                <md-option v-for="time in tariffService.times"
                                                           :value="time.time"
                                            ...
                                            <span class="md-error">{{ errors.first('Tariff-Form.end'+tou.id) }}</span>
                                        </md-field>
                                    </div>
                                    <div
                                            class="md-layout-item md-xlarge-size-20 md-large-size-20 md-medium-size-20 md-small-size-20">
