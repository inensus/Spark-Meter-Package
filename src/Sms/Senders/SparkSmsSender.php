...
abstract class SparkSmsSender
{
    ...
    public function __construct($data, SmSmsBodyService $smsBodyService)
    {
    ...
    public function prepareHeader()
    {
        ...
        $className = 'Inensus\\SparkMeter\\Sms\\BodyParsers\\' . $this->references['header'];
    ...
    public function prepareBody()
    {
        ...
        $className = 'Inensus\\SparkMeter\\Sms\\BodyParsers\\' . $this->references['body'];
        $smsObject = new $className($this->data);
        $this->body .= ' ' . $smsObject->parseSms($smsBody->body);
    }
